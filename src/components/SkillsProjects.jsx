...
const SkillBar = ({ label, level }) => {
  return (
    <div>
      ...
      <div className="relative h-2 w-full overflow-hidden rounded-full bg-[#0e1628] ring-1 ring-cyan-400/20">
        <div
...
export default function SkillsProjects() {
  return (
    <section id="skills" className="relative w-full bg-[#070b14] py-16 text-white">
      <div className="absolute inset-0 pointer-events-none bg-[radial-gradient(ellipse_at_bottom,rgba(8,47,73,0.25),rgba(2,6,23,0.15))]" />
      <div className="relative mx-auto grid max-w-6xl grid-cols-1 gap-10 px-6 md:grid-cols-2">
        ...
        <div className="rounded-2xl bg-[#0b1220]/70 p-6 ring-1 ring-cyan-400/20 backdrop-blur">
          <h3 className="text-xl font-semibold text-cyan-200">Skills</h3>
        ...
        {/* Projects */}
        <div id="portfolio" className="rounded-2xl bg-[#0b1220]/70 p-6 ring-1 ring-cyan-400/20 backdrop-blur">
          <h3 className="text-xl font-semibold text-cyan-200">Portfolio / Projects</h3>
          <div className="mt-6 grid gap-5">
            {[{
              ...
              <div key={idx} className="group relative overflow-hidden rounded-xl bg-[#0f1729] p-5 ring-1 ring-cyan-400/20 transition-transform duration-300 hover:-translate-y-0.5">
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-gradient-to-r from-cyan-500/10 to-blue-600/10" />
                <div className="relative flex items-start gap-3">
                  <CheckCircle2 className="mt-1 h-5 w-5 text-cyan-300 flex-shrink-0" />
                  <div>
                    <h4 className="font-semibold text-cyan-100">{p.title}</h4>
